...
u32 XAdder_Get_c(XAdder *InstancePtr) {
    ...
    Data = XAdder_ReadReg(InstancePtr->Control_BaseAddress, XADDER_CONTROL_ADDR_C_DATA);
    return Data;
}
...
u32 XAdder_Get_c_vld(XAdder *InstancePtr) {
    ...
    Data = XAdder_ReadReg(InstancePtr->Control_BaseAddress, XADDER_CONTROL_ADDR_C_CTRL);
    return Data & 0x1;
}
