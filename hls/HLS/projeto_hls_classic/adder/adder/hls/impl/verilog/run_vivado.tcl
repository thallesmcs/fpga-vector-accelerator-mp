...
set ip_vlnv xilinx.com:hls:adder:1.0
set ip_repo_path ../ip
...
dict set report_options hls_project adder
...
dict set report_options topmodule "adder"
dict set report_options funcmodules {}
dict set report_options bindmodules adder_control_s_axi
