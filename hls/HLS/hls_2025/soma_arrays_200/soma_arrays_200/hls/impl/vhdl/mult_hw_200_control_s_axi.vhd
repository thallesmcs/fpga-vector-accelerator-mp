...
entity mult_hw_200_control_s_axi is
generic (
...
end entity mult_hw_200_control_s_axi;
...
--          others - reserved
-- 0x1000 ~
-- 0x13ff : Memory 'A' (200 * 32b)
--          Word n : bit [31:0] - A[n]
-- 0x2000 ~
-- 0x23ff : Memory 'B' (200 * 32b)
--          Word n : bit [31:0] - B[n]
-- 0x3000 ~
-- 0x33ff : Memory 'C' (200 * 32b)
--          Word n : bit [31:0] - C[n]
-- (SC = Self Clear, COR = Clear on Read, TOW = Toggle on Write, COH = Clear on Handshake)

architecture behave of mult_hw_200_control_s_axi is
    ...
    constant ADDR_A_HIGH  : INTEGER := 16#13ff#;
    constant ADDR_B_BASE  : INTEGER := 16#2000#;
    constant ADDR_B_HIGH  : INTEGER := 16#23ff#;
    ...
    -- memory signals
    signal int_A_address0      : UNSIGNED(7 downto 0);
    signal int_A_ce0           : STD_LOGIC;
    signal int_A_q0            : UNSIGNED(31 downto 0);
    signal int_A_address1      : UNSIGNED(7 downto 0);
    ...
    signal int_B_address0      : UNSIGNED(7 downto 0);
    signal int_B_ce0           : STD_LOGIC;
    signal int_B_q0            : UNSIGNED(31 downto 0);
    signal int_B_address1      : UNSIGNED(7 downto 0);
    ...
    component mult_hw_200_control_s_axi_ram is
        generic (
    ...
    end component mult_hw_200_control_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_A
int_A : mult_hw_200_control_s_axi_ram
generic map (
     MEM_STYLE  => "auto",
     MEM_TYPE   => "2P",
     BYTE_WIDTH => 8,
...
port map (
     ...
     q1         => int_A_q1);
-- int_B
int_B : mult_hw_200_control_s_axi_ram
generic map (
     MEM_STYLE  => "auto",
     MEM_TYPE   => "2P",
     BYTE_WIDTH => 8,
...
port map (
     ...
     q1         => int_B_q1);
-- int_C
int_C : mult_hw_200_control_s_axi_ram
generic map (
     MEM_STYLE  => "auto",
     MEM_TYPE   => "S2P",
     BYTE_WIDTH => 8,
...
-- ----------------------- Memory logic ------------------
    -- A
    int_A_address0       <= RESIZE(UNSIGNED(A_address0), 8);
    int_A_ce0            <= A_ce0;
    A_q0                 <= STD_LOGIC_VECTOR(RESIZE(int_A_q0, 32));
    int_A_address1       <= raddr(9 downto 2) when ar_hs = '1' else waddr(9 downto 2);
    ...
    -- B
    int_B_address0       <= RESIZE(UNSIGNED(B_address0), 8);
    int_B_ce0            <= B_ce0;
    B_q0                 <= STD_LOGIC_VECTOR(RESIZE(int_B_q0, 32));
    int_B_address1       <= raddr(9 downto 2) when ar_hs = '1' else waddr(9 downto 2);
...
entity mult_hw_200_control_s_axi_ram is
    generic (
        MEM_STYLE  : STRING :="auto";
        MEM_TYPE   : STRING :="S2P";
        BYTE_WIDTH : INTEGER :=8;
...
end entity mult_hw_200_control_s_axi_ram;

architecture behave of mult_hw_200_control_s_axi_ram is
