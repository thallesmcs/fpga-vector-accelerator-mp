...
entity mult_hw_1000_control_s_axi is
generic (
...
end entity mult_hw_1000_control_s_axi;
...
architecture behave of mult_hw_1000_control_s_axi is
    ...
    component mult_hw_1000_control_s_axi_ram is
        generic (
    ...
    end component mult_hw_1000_control_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_A
int_A : mult_hw_1000_control_s_axi_ram
generic map (
     MEM_STYLE  => "auto",
     MEM_TYPE   => "2P",
     BYTE_WIDTH => 8,
...
port map (
     ...
     q1         => int_A_q1);
-- int_B
int_B : mult_hw_1000_control_s_axi_ram
generic map (
     MEM_STYLE  => "auto",
     MEM_TYPE   => "2P",
     BYTE_WIDTH => 8,
...
port map (
     ...
     q1         => int_B_q1);
-- int_C
int_C : mult_hw_1000_control_s_axi_ram
generic map (
     MEM_STYLE  => "auto",
     MEM_TYPE   => "S2P",
     BYTE_WIDTH => 8,
...
entity mult_hw_1000_control_s_axi_ram is
    generic (
        MEM_STYLE  : STRING :="auto";
        MEM_TYPE   : STRING :="S2P";
        BYTE_WIDTH : INTEGER :=8;
...
end entity mult_hw_1000_control_s_axi_ram;

architecture behave of mult_hw_1000_control_s_axi_ram is
