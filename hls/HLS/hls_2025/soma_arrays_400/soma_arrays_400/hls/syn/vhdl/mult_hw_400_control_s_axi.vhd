...
entity mult_hw_400_control_s_axi is
generic (
...
port (
    ...
    B_address0            :in   STD_LOGIC_VECTOR(8 downto 0);
    B_ce0                 :in   STD_LOGIC;
    B_q0                  :out  STD_LOGIC_VECTOR(31 downto 0);
    C_address0            :in   STD_LOGIC_VECTOR(8 downto 0);
    C_ce0                 :in   STD_LOGIC;
    C_we0                 :in   STD_LOGIC;
...
end entity mult_hw_400_control_s_axi;
...
architecture behave of mult_hw_400_control_s_axi is
    ...
    constant ADDR_A_HIGH  : INTEGER := 16#17ff#;
    constant ADDR_B_BASE  : INTEGER := 16#2000#;
    constant ADDR_B_HIGH  : INTEGER := 16#27ff#;
    constant ADDR_C_BASE  : INTEGER := 16#3000#;
    constant ADDR_C_HIGH  : INTEGER := 16#37ff#;
    ...
    -- memory signals
    signal int_A_address0      : UNSIGNED(8 downto 0);
    signal int_A_ce0           : STD_LOGIC;
    signal int_A_q0            : UNSIGNED(31 downto 0);
    signal int_A_address1      : UNSIGNED(8 downto 0);
    ...
    signal int_B_address0      : UNSIGNED(8 downto 0);
    signal int_B_ce0           : STD_LOGIC;
    signal int_B_q0            : UNSIGNED(31 downto 0);
    signal int_B_address1      : UNSIGNED(8 downto 0);
    ...
    end component mult_hw_400_control_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_A
int_A : mult_hw_400_control_s_axi_ram
generic map (
     MEM_STYLE  => "auto",
     MEM_TYPE   => "2P",
     BYTE_WIDTH => 8,
...
port map (
     ...
     q1         => int_A_q1);
-- int_B
int_B : mult_hw_400_control_s_axi_ram
generic map (
     MEM_STYLE  => "auto",
     MEM_TYPE   => "2P",
     BYTE_WIDTH => 8,
...
port map (
     ...
     q1         => int_B_q1);
-- int_C
int_C : mult_hw_400_control_s_axi_ram
generic map (
     MEM_STYLE  => "auto",
     MEM_TYPE   => "S2P",
     BYTE_WIDTH => 8,
...
-- ----------------------- Memory logic ------------------
    -- A
    int_A_address0       <= RESIZE(UNSIGNED(A_address0), 9);
    int_A_ce0            <= A_ce0;
    A_q0                 <= STD_LOGIC_VECTOR(RESIZE(int_A_q0, 32));
    int_A_address1       <= raddr(10 downto 2) when ar_hs = '1' else waddr(10 downto 2);
    ...
    -- B
    int_B_address0       <= RESIZE(UNSIGNED(B_address0), 9);
    int_B_ce0            <= B_ce0;
    B_q0                 <= STD_LOGIC_VECTOR(RESIZE(int_B_q0, 32));
    int_B_address1       <= raddr(10 downto 2) when ar_hs = '1' else waddr(10 downto 2);
    ...
    -- C
    int_C_address0       <= RESIZE(UNSIGNED(C_address0), 9);
    int_C_ce0            <= C_ce0;
    int_C_be0            <= (others => C_we0);
    int_C_d0             <= RESIZE(UNSIGNED(C_d0), 32);
    int_C_address1       <= raddr(10 downto 2);
...
entity mult_hw_400_control_s_axi_ram is
    generic (
        MEM_STYLE  : STRING :="auto";
        MEM_TYPE   : STRING :="S2P";
        BYTE_WIDTH : INTEGER :=8;
...
end entity mult_hw_400_control_s_axi_ram;

architecture behave of mult_hw_400_control_s_axi_ram is
