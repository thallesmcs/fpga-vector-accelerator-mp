...
// ==============================================================
`timescale 1ns/1ps
module mult_hw_400_control_s_axi
#(parameter
    ...
    input  wire [8:0]                    A_address0,
    input  wire                          A_ce0,
    output wire [31:0]                   A_q0,
    input  wire [8:0]                    B_address0,
    input  wire                          B_ce0,
    output wire [31:0]                   B_q0,
    input  wire [8:0]                    C_address0,
    input  wire                          C_ce0,
    input  wire                          C_we0,
...
localparam
    ...
    ADDR_A_HIGH  = 14'h17ff,
    ADDR_B_BASE  = 14'h2000,
    ADDR_B_HIGH  = 14'h27ff,
    ADDR_C_BASE  = 14'h3000,
    ADDR_C_HIGH  = 14'h37ff,
    WRIDLE       = 2'd0,
    WRDATA       = 2'd1,
    WRRESP       = 2'd2,
    WRRESET      = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg                           int_A_read;
    reg                           int_A_write;
    wire [8:0]                    int_B_address0;
    wire                          int_B_ce0;
    wire [31:0]                   int_B_q0;
    wire [8:0]                    int_B_address1;
    wire                          int_B_ce1;
    wire [3:0]                    int_B_be1;
    wire                          int_B_we1;
    wire [31:0]                   int_B_d1;
    ...
    reg                           int_B_read;
    reg                           int_B_write;
    wire [8:0]                    int_C_address0;
    wire                          int_C_ce0;
    wire [3:0]                    int_C_be0;
    wire [31:0]                   int_C_d0;
    wire [8:0]                    int_C_address1;
    wire                          int_C_ce1;
    wire [31:0]                   int_C_q1;
    reg                           int_C_read;
    reg                           int_C_write;
...
assign int_A_address1 = ar_hs ? raddr[10:2] : waddr[10:2];
...
assign int_B_address1 = ar_hs ? raddr[10:2] : waddr[10:2];
...
assign int_C_address1 = raddr[10 : 2];
...
module mult_hw_400_control_s_axi_ram
#(parameter
    MEM_STYLE  = "auto",
    MEM_TYPE   = "S2P",
    BYTE_WIDTH = 8,
