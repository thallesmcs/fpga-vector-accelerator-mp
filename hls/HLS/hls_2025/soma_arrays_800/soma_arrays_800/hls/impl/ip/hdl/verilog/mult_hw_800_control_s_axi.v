...
// ==============================================================
`timescale 1ns/1ps
module mult_hw_800_control_s_axi
#(parameter
...
//------------------------Local signal-------------------
    ...
    reg                           int_B_read;
    reg                           int_B_write;
    wire [9:0]                    int_C_address0;
    wire                          int_C_ce0;
    wire [3:0]                    int_C_be0;
    wire [31:0]                   int_C_d0;
    wire [9:0]                    int_C_address1;
    wire                          int_C_ce1;
    wire [31:0]                   int_C_q1;
    reg                           int_C_read;
    reg                           int_C_write;
...
assign int_C_address1 = raddr[11 : 2];
...
module mult_hw_800_control_s_axi_ram
#(parameter
    MEM_STYLE  = "auto",
    MEM_TYPE   = "S2P",
    BYTE_WIDTH = 8,
