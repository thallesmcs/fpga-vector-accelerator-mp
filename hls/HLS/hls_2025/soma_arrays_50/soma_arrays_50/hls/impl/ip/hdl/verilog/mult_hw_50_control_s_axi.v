...
// ==============================================================
`timescale 1ns/1ps
module mult_hw_50_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_A_HIGH  = 14'h10ff,
    ADDR_B_BASE  = 14'h2000,
    ADDR_B_HIGH  = 14'h20ff,
    ADDR_C_BASE  = 14'h3000,
    ADDR_C_HIGH  = 14'h30ff,
    WRIDLE       = 2'd0,
    WRDATA       = 2'd1,
    WRRESP       = 2'd2,
    WRRESET      = 2'd3,
...
assign int_C_address1 = raddr[7 : 2];
...
module mult_hw_50_control_s_axi_ram
#(parameter
    MEM_STYLE  = "auto",
    MEM_TYPE   = "S2P",
    BYTE_WIDTH = 8,
