...
// 
// ==============================================================
#ifndef XMULT_HW_50_H
#define XMULT_HW_50_H
...
#ifndef __linux__
#define XMult_hw_50_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XMult_hw_50_ReadReg(BaseAddress, RegOffset) \
...
#else
int XMult_hw_50_Initialize(XMult_hw_50 *InstancePtr, const char* InstanceName);
int XMult_hw_50_Release(XMult_hw_50 *InstancePtr);
#endif
